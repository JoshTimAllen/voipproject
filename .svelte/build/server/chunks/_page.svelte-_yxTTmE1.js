import { c as create_ssr_component, v as validate_component, b as add_attribute, d as each, e as escape, m as missing_component } from './ssr-pFtfi_2X.js';
import { V as Voice } from './voice-fIta6n6h.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-q8dq09_START --><!-- HEAD_svelte-q8dq09_END -->`, ""} ${validate_component(Voice || missing_component, "svelte:component").$$render(
      ...
      {}
    )} <div class="page-content h-100"><main class="left-content side-main flex w-100" style=""><div class="d-flex flex-column align-items-stretch flex-shrink-0 w-100"><a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom" data-svelte-h="svelte-1446c07"><svg class="bi me-2" width="30" height="24"><use xlink:href="#bootstrap"></use></svg> <span class="fs-5 fw-semibold">VP</span></a> <div class="px-4 d-none d-md-block"><div class="d-flex align-items-center"><div class="flex-grow-1"><input type="text" class="form-control my-3" placeholder="Search..."${add_attribute("value", SearchQuery, 0)}></div></div></div> <div class="list-group list-group-flush border-bottom scrollarea w-100"> ${each(searchResults, (searchResult) => {
      return `<a href="">${validate_component(Cardtype1 || missing_component, "svelte:component").$$render($$result, { model: GetModel(searchResult.username) }, {}, {})}</a>`;
                                    ...
                                    Morbi varius quam ac venenatis tempus.</div></div></div></div> <div class="search-bar-section flex-grow-0 py-3 px-4 border-top" data-svelte-h="svelte-npnhqy"><div class="input-group"><input type="text" class="form-control" placeholder="Type your message"> <button class="btn btn-primary">Send</button></div></div></div></div></div></main> </div>`;
  } while (!$$settled);
  return $$rendered;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-_yxTTmE1.js.map
