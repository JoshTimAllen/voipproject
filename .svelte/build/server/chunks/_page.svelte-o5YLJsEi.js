import { c as create_ssr_component, v as validate_component, e as escape, m as missing_component, a as subscribe, b as add_attribute, g as getContext, s as setContext } from './ssr-pFtfi_2X.js';
import { w as writable } from './index2-ZRW2DYhJ.js';
...
const css = {
  code: ".touched:invalid{border-color:red;outline-color:red}",
  map: null
};
const Loginform = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_form();
  return `<form><h1 data-svelte-h="svelte-1wsy7a9">Login</h1> <input type="username" name="username"${add_attribute("value", username, 0)}> <br>  <input type="password" name="password"${add_attribute("value", password, 0)}> ${validate_component(Hint, "Hint").$$render($$result, { for: "password", on: "required" }, {}, {
    default: () => {
      return `This is a mandatory field`;
    }
  })} <button ${!$form.valid ? "disabled" : ""}>Login</button></form> <pre data-svelte-h="svelte-1nuqo7a">  
  </pre>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `  <button>${`Register`}</button> ${`${validate_component(Loginform || missing_component, "svelte:component").$$render($$result, {}, {}, {})}`} ${escape(JSON.stringify(data))} `;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-o5YLJsEi.js.map
