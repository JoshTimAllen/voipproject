...
import { V as Voice } from './voice-yhbah5mc.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-q8dq09_START --><!-- HEAD_svelte-q8dq09_END -->`, ""} ${validate_component(Voice || missing_component, "svelte:component").$$render(
      ...
      {}
    )} <div class="page-content h-100"><main class="left-content side-main flex w-100" style=""><div class="d-flex flex-column align-items-stretch flex-shrink-0 w-100"><a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom"><svg class="bi me-2" width="30" height="24"><use xlink:href="#bootstrap"></use></svg> <span class="fs-5 fw-semibold">${escape("jhj")}</span></a> <div class="px-4 d-none d-md-block"><div class="d-flex align-items-center"><div class="flex-grow-1"><input type="text" class="form-control my-3" placeholder="Search..."${add_attribute("value", SearchQuery, 0)}></div></div></div> <div class="list-group list-group-flush border-bottom scrollarea w-100"> ${each(searchResults, (searchResult) => {
...
//# sourceMappingURL=_page.svelte-wjER1JL8.js.map
